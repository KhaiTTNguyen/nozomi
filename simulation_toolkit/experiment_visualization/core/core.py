...
def gather_experiment_files(base_folder):
    """
    ...
    for experiment_dir in data_path.iterdir():
        ...
        # Look for ADCdata folders in the experiment directory
        for root, dirs, files in os.walk(experiment_dir):
            if 'ADCdata' in os.path.basename(root):
                # print(f"  Found ADCdata folder: {root}")
                
                # Process all .pkl files in this ADCdata folder
                for filename in files:
                    if filename.endswith('.pkl'):
                        ...
                        if k_value and diameter and compartment:
                            ...
                            # print(f"    Added: K={k_value}, {compartment}, d={diameter}")
                        else:
...
def get_files_by_criteria(organized_files, k_value=None, compartment=None, diameter=None):
    """
