...
./run-scripts/run-simulation.sh --substrates=./experiment/result/2026-03-22_bead_1.24/bead1.24_d2.58_OD10_initVF0.17_500axons --gpu=2 --sim_time=100  --nseg=20 --compartment=intra
