...
./run-scripts/run-geometry-gen.sh --gpu=4 --config=./experiment/setup/substrate/single_substrate/2026-03-22-bead1.24/d45-K10-beading1.24-substrate.json --output_folder_path=./experiment/result/2026-03-22_bead_1.24
```
