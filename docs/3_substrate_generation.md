...
./run-scripts/run-geometry-gen.sh --gpu=5 --config=./experiment/setup/substrate/single_substrate/2026-03-22-bead0.3/d45-K10-beading0.3-substrate.json --output_folder_path=./experiment/result/2026-03-22-bead03
```
