...
#         sy = np.cos(6*np.pi*sz/Ly/2)*10
#         sx = np.linspace(-Lx/5, Lx/5, nsphere)
#         sr = np.full(sz.shape, 3.)

#         nsphere = 100 
#         sz2 = np.linspace(-Lx/2, Lx/2, nsphere)
#         sy2 = np.cos(6*np.pi*sz2/Ly/2)*1
#         sx2 = np.linspace(Lx/5, -Lx/5, nsphere)
#         sr2 = np.full(sz2.shape, 3.)
...
#                 ax.set_ylabel("y (um)")
#                 ax.set_zlabel("z (um)")
#                 spin_plot_file_name = str(date_time)+'_'+'COSINE_outside_at'+str(n)+'.png'
...
#         nsphere = 100
#         sz = np.linspace(-Lx/2, Lx/2, nsphere)
#         sy = np.cos(6*np.pi*sz/Ly/2)*20
#         sx = np.linspace(-Lx/5, Lx/5, nsphere)
#         sr = np.full(sz.shape, 10.)

#         nsphere = 100 
#         sz2 = np.linspace(-Lx/2, Lx/2, nsphere)
#         sy2 = np.cos(6*np.pi*sz2/Ly/2)*1
#         sx2 = np.linspace(Lx/5, -Lx/5, nsphere)
#         sr2 = np.full(sz2.shape, 10.)
...
#         sx4 = np.sin(2*np.pi*sz4/Ly*3)*5+ 35
#         sy4 = np.full(sz4.shape, 0)
#         sr4 = np.full(sz4.shape, 8.)
...
#         sx5 = np.sin(2*np.pi*sz5/Ly*3)*5 - 35.
#         sy5 = np.full(sz5.shape, 0)
#         sr5 = np.full(sz5.shape, 8.)
...
#                 ax.set_ylabel("y (um)")
#                 ax.set_zlabel("z (um)")
#                 spin_plot_file_name = str(date_time)+'_'+'COSINE_inside_at'+str(n)+'.png'
#                 spin_plot_file_name = os.path.join(spin_folder_name, spin_plot_file_name)
#                 pl.savefig(spin_plot_file_name)
#                 plt.close(fig)
#                 # self.assertTrue(isOutside.all())
