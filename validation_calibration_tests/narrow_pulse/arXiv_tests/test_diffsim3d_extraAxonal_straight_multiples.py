...
#         # sy = np.sin(2*np.pi*sz/Ly*3)*5 +10
#         sy = np.full(sz.shape, 10.5)
...
#         sx3 = np.full(sz3.shape, 10.5)
#         sy3 = np.full(sz3.shape, 0)
...
#         fib_list = [fib1, fib2, fib3, fib4, fib5]
...
#         sx111 = np.full(sz111.shape, 20.5)
...
#         sy333 = np.full(sz333.shape, -20.5)
